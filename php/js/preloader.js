(function() {
	...
	function animate( time ){
		...
		if (times > 29) ctx.drawImage(bus_1, 0, 0);
		if (times > 39) ctx.drawImage(eiffel, 0, 0);
		if (times > 49) ctx.drawImage(pyramids, 0, 0);
		if (times > 59) ctx.drawImage(opera, 0, 0);
		if (times > 69) ctx.drawImage(pisa, 0, 0);
		if (times > 79) ctx.drawImage(bus_2, 0, 0);
		if (times > 89) ctx.drawImage(bottom_pillar, 0, 0);
		if (times > 99) ctx.drawImage(gateway, 0, 0);
		if (times > 109) ctx.drawImage(triangle, 0, 0);
		if (times > 119) ctx.drawImage(bigben, 0, 0);
		if (times > 129) ctx.drawImage(christ, 0, 0);
		if (times > 139) ctx.drawImage(left_pillar, 0, 0);
		if (times > 149) ctx.drawImage(liberty, 0, 0);
		if (times > 159) ctx.drawImage(taj, 0, 0);
		if (times > 169) ctx.drawImage(nitk, 0, 0);
