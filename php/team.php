	...
	<main>
		...
		<div class="team-landing-screen container">
			...
			<div class="row">
				<div class="col l6 m6 s12 center add-icons">
					...
					<a target="_blank" href="#!" style="margin-left: 15px;">
						<svg style="width: 30px; height: 30px;" viewBox="0 0 24 24">
		...
		<div class="teams-container">
			<div class="row valign-wrapper teams-container-row">
				<div class="col s12 m3 l3"><h1 class="team-heading-name center">Web Dev</h1></div>
				<div class="col s12 m9 l9 members-container">
					<div class="team-member center">
						<img src="http://via.placeholder.com/200x200" class="circle" />
						<h4 class="team-name">Name 1</h4>
						<p class="team-details-para"><a href="mailto:incidentmarketing@nitk.edu.in">incidentmarketing@nitk.edu.in</a><br/>+91 12345 65432</p>
						<a target="_blank" href="#!">
							<svg style="width: 30px; height: 30px;" viewBox="0 0 24 24">
								<path fill="#4267B2" d="M5,3H19A2,2 0 0,1 21,5V19A2,2 0 0,1 19,21H5A2,2 0 0,1 3,19V5A2,2 0 0,1 5,3M18,5H15.5A3.5,3.5 0 0,0 12,8.5V11H10V14H12V21H15V14H18V11H15V9A1,1 0 0,1 16,8H18V5Z"></path>
							</svg>
			...
			<div class="row valign-wrapper teams-container-row">
				<div class="col s12 m3 l3"><h1 class="team-heading-name center">Marketing</h1></div>
				<div class="col s12 m9 l9 members-container">
					<div class="team-member center">
						<img src="http://via.placeholder.com/200x200" class="circle" />
						<h4 class="team-name">Name 1</h4>
